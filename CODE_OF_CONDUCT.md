...
Если вы стали свидетелем нарушения или сами пострадали — сообщите через  
[`GitHub Discussions`](https://github.com/orgs/selfshop-dev/discussions)  
или напрямую мейнтейнеру.
